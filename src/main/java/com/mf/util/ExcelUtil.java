...
public class ExcelUtil {
     ...
     */
    public static String exportExcel(String sheetName, String titleName, String[] headers, Collection<?> dataSet, String pattern,String fileName) {
        FileSystemView fsv = FileSystemView.getFileSystemView();
        String path = fsv.getHomeDirectory().toString();
        String requstUrl = path + "/" + fileName;
        System.out.println(path);
        String msg = doExportExcel(sheetName, titleName, headers, dataSet, pattern,requstUrl);
        return msg;
     ...
     * 功能:真正实现导出
     */
    private static String doExportExcel(String sheetName,String titleName,String[] headers,Collection<?> dataSet,String pattern,String resultUrl) {
        ...
        try {
            outputStream = new FileOutputStream(resultUrl);
